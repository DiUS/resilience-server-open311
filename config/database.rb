...
database_name = case Padrino.env
  when :development then 'resilience_development'
  when :production  then 'resilience_production'
  when :test        then 'resilience_test'
end
...
#     sessions:
#       default:
#         database: open311_development
#         hosts:
#           - localhost:27017 
#   production:
#     sessions:
#       default:
#         database: open311_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: open311_test
#         hosts:
#           - localhost:27017
#
#
